		...
		<div id="contents">
			<article>
				...
				<div class="post" style="text-align:left">
					<span class="StalinistOne" style="text-align:center;display:block">Project REMIND</span><br>
					<div>
						기간: 2017년 8월 12일 ~ 2018년 8월 12일 (실제 서비스 기간은 연장될 수 있음.)<br><br>
						목표: <br>
								 1. 수많은 게이머들에게 웹 게임의 발전 가능성을 제시한다.<br><br>
								 2. 게임 및 웹 소스 코드 공개를 통해 많은 개발자들을 지원한다.<br><br>
								 3. 프로젝트에 참여함으로써 웹과 프로그래밍에 대한 지식 범위를 넓게 한다.<br><br>
								 4. 금전적 이익 추구를 배제하며 발생하는 수익은 전부 투명하게 공개함과 동시에 프로젝트의 발전 또는 사회에 기부한다. 이를 통해 사회 발전에 일부 기여한다.<br><br>
						계획: 프로젝트 참여자들과 함께 웹 페이지를 개선해나가며 발전시킨다. 후원등으로 발생하는 금전적 이익은 출처(후원자가 원치 않을 시 본명 대신 '익명'으로 기제함.) 및 금액 등을 페이지에 명시하며 사용 또한 정확하게 명시한다.
								참여자 모집과 개선 및 발전을 계속해서 진행해나가며 우리또한 발전하게 될 것이다.<br><br>
						참여 인원 제한: 없음. (후에 제한될 수 있음.)<br><br>
						프로젝트 참여 자격:<br>
						 		프로젝트 참여를 통한 <b>금전적 이익을 추구하지 않으며</b> 다음 조건 중 하나 이상을 만족하는 자.<br><br>
								1. 게임 개발. 프로젝트에서 사용될 웹 프로그래밍 언어를 숙지하여 웹 게임 개발에 참여할 자.(HTML, CSS, Javascript, PHP)<br><br>
								2. DB관리 및 백엔드 개발. Mysql 데이터베이스 및 PHP sql문법을 숙지하였으며 WAMP사용을 통한 웹 백엔드 개발에 능숙한 자.<br><br>
								3. 디자인. HTML과 CSS를 숙지하고 웹 디자인에 능숙한 자.<br><br>
								4. 이외의 방법으로 프로젝트 발전에 기여할 자.<br><br>
						참여 방법: REMIND 카카오톡 문의. <a href="https://open.kakao.com/o/sEQZfcA" style="text-decoration:underline;color:skyblue">이곳을 클릭하여 오픈 채팅방으로 이동.</a><br>
					</div>
				</div>
			</article>
		</div>
		<div id=back-button onclick="back(4)">< 뒤로가기</div>
	</body>
</html>
